<template>
    ...
    <div class="lg:px-40 px-3 flex items-center py-2 bg-white">
        ...
        <div class="text-[#3bb77e]">Tất cả sản phẩm</div>
    </div>
    <div class="lg:px-40 px-3 bg-[#f4f5f9]">
        <div class="grid grid-cols-7 gap-4">
            ...
            <div class="lg:col-span-5 col-span-7">
                <h3 class="md:text-3xl text-xl font-bold">Tất cả sản phẩm</h3>
                <Sort 
        ...
        <button 
            ...
            data-drawer-target="drawer-menu-products" 
            data-drawer-show="drawer-menu-products" 
        ...
        >
            ...
            <button type="button" data-drawer-hide="drawer-menu-products" aria-controls="drawer-menu-products" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 right-2.5 inline-flex items-center justify-center" >
